...
model = AutoModelForCausalLM.from_pretrained('TheBloke/Mistral-7B-OpenOrca-GPTQ', trust_remote_code=False, device_map="auto", revision="main", token=access_token)
...
tokenizer = AutoTokenizer.from_pretrained('TheBloke/Mistral-7B-OpenOrca-GPTQ', use_fast=True, token=access_token)
